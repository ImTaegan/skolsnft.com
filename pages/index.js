...
export default function Index() {
  return (
    <>
      ...
      <section className="grid grid-cols-none grid-flow-row gap-8 max-w-screen-xl xl:mx-auto mx-8 md:mx-12 lg:mx-20 lg:my-10">
        <h1 className="col-span-1">Welcome to SKOLs</h1>
        <div>
          <p className="md:col-span-1 mb-4 md:mb-6">
        ...
        <a
          href="#"
          className="w-full md:w-60 md:justify-self-center md:col-start-1 md:col-end-3 md:row-start-3 xl:col-end-1 px-3 py-3 text-center text-base font-medium lg:text-xl xl:text-2xl bg-gray-900 hover:bg-gray-700 hover:text-white text-white hover:no-underline transition-colors duration-200">
          MINT 11/21
        </a>
        <div className="flex md:col-start-2 md:col-end-2 md:row-start-1 md:row-end-3 xl:row-end-4 order-1">
          <Image
            src="/about.gif"
            alt="SKOLs"
            width={949}
      ...
      <section className="max-w-screen-xl grid grid-rows-auto gap-8 xl:mx-auto mx-8 md:mx-12 lg:mx-20 lg:my-10">
      ...
      <section className="relative w-full h-40 lg:h-60">
        <Image src="/cover.png" alt="SKOLs" layout="fill" objectFit="cover" />
      </section>
      <section className="grid md:grid-cols-2 md:max-w-screen-xl mx-8 md:mx-12 lg:mx-20 lg:my-10 gap-8 xl:mx-auto">
        <h1 className="text-center col-span-full">Roadmap</h1>
        <div>
          <h1 className="mb-6">25% SOLD</h1>
          <p>
      ...
      <section className="grid gap-8 md:max-w-screen-xl mx-8 md:mx-12 lg:mx-20 lg:my-10 xl:mx-auto">
